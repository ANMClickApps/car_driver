...
import 'package:car_driver/helpers/mapkit_helper.dart';
import 'package:car_driver/model/trip_details.dart';
import 'package:car_driver/style/brand_color.dart';
import 'package:car_driver/widgets/collect_payment_dialog.dart';
...
class _NewTripScreenState extends State<NewTripScreen> {
  ...
  Color buttonColor = BrandColor.colorPrimary;
  Timer timer;
          ...
          children: [
            GoogleMap(
              ...
              onMapCreated: (GoogleMapController controller) async {
                ...
                setState(() {
                  mapPaddingBottom = (Platform.isIOS) ? 255.0 : 260.0;
                });
                var currentLatLng =
                    LatLng(currentPosition.latitude, currentPosition.longitude);
                var pickupLatLng = widget.tripDetails.destination;
            ...
            Positioned(
              ...
              child: Container(
                ...
                height: Platform.isIOS ? 280.0 : 255.0,
                child: Padding(
                  padding:
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                            ...
                            color: BrandColor.colorAccentPurple),
                      ),
                      SizedBox(height: 5.0),
                      Row(
                        ...
                        onPressed: () async {
                          if (status == 'accepted') {
                            ...
                            setState(() {
                              ...
                              buttonColor = BrandColor.colorAccentPurple;
                            });
  ...
  Future<void> getDirection(
    ...
    rideMapController.animateCamera(CameraUpdate.newLatLngBounds(bounds, 70.0));
  ...
  void acceptTrip() {
    ...
    DatabaseReference historyRef = FirebaseDatabase.instance
        .reference()
        .child('drivers/${userFirebase.uid}/history/$rideID');
  ...
  void getLocationUpdates() {
    ...
    ridePositionStream = Geolocator.getPositionStream(
      ...
      var rotation = MapKitHelper.getMarkerRotaton(oldPosition.latitude,
      ...
      setState(() {
        CameraPosition cp = CameraPosition(target: pos, zoom: 17.0);
